...
?></h1>
    ...
    <table border="1" width="100%">
        ...
        <?php if (is_array($beans) && !empty($beans)) {
          foreach ($beans as $bean) { ?>
              <tr>
                  ...
                  <td><a href="../Controller/C_.php?action=detail&one=<?php echo $bean->getOne() ?>">xem chi tiết</a></td>
                  <td>
      ...
      <!-- deleteall -->
      <tr><td colspan="5" style="text-align: end;"><button onclick="handledelete()" style="background:red;">Xóa nhiều</button></td></tr>  
